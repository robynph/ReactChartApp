...
/* modelContract - This contract governs the transaction for a remote machine learning service.  
...
contract Mocel {
    ...
    */
    ...
    function Mocel(uint _modelID, uint _contractRate) public payable {
        require( contractRate  == msg.value); /* Check the funds before we burn any additional gas */
        seller = msg.sender;
        value = msg.value;
        modelID = _modelID;
